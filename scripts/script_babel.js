...
$(document).ready(function () {
    $('#button_next').on('click', function () {
        ...
        $('#first_photos li:last').delay(500).queue(function (next) {
        ...
        $('#second_photos li:last').delay(500).queue(function (next) {
    ...
    $('#button_prev').on('click', function () {
        ...
        $('#first_photos li:first').delay(500).queue(function (next) {
        ...
        $('#second_photos li:first').delay(500).queue(function (next) {
